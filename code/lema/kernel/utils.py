# lema/kernel is vendored from stickbreaking_attention (Tan et al., 2025), Apache 2.0, see
# LICENSE; upstream https://github.com/shawntan/stickbreaking-attention; changes are marked
# '# lema patch'.
import torch
